...
def main(project, size):
    for folder in ['train', 'test']:
        image_path = os.path.join(project, 'images', folder)
        rescale_images(image_path, size)        

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Rescale images")
    parser.add_argument('-p', '--project', type=str, required=True, help='name of the directory containing the "images/train" and "images/test" subdirs')
